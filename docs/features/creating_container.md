...
<!--codeinclude--> 
[Creating a Redis container](../example/src/test/java/generic/ContainerCreationTest.java) inside_block:simple
<!--/codeinclude-->

Further options may be specified, for example:

<!--codeinclude--> 
[Creating a container with more options](../example/src/test/java/generic/ContainerCreationTest.java) inside_block:withOptions
<!--/codeinclude-->
